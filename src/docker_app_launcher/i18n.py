...
STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "background_tray": "Running in the system tray. Double-click the tray icon to restore.",
        "background_iconified": "Running in the background. Restore the window from the taskbar.",
        "closed_minimized": "App keeps running; window minimized.",
    ...
    "de": {
        ...
        "run_in_background": "Im Hintergrund weiterlaufen",
        "background_tray": "Laeuft im System-Tray. Doppelklick auf das Tray-Icon stellt das Fenster wieder her.",
        "background_iconified": "Laeuft im Hintergrund. Fenster ueber die Taskleiste wiederherstellen.",
        "closed_minimized": "App laeuft weiter. Fenster minimiert.",
